  ...
  <div class='block'>
    ...
    <h1>Sign up</h1>
      <div class='form-control'>
        ...
        <a href="login.php" style="display: block; width: 100%; margin-top: 5px; margin-bottom: 15px;">Already have an account? Sign in</a>
        <button type="submit" name='submit' class="buttonSubmit">Create Account</button>
