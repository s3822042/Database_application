...
<body>
		...
		<div class="flex flex-row my-2 justify-evenly">
			<div class="my-5">
				<div class="block">
					...
					<input type="text" name="pname" id="inputName" class="rounded-sm bg-gray-300/50">

				</div>
				<div class="block my-2">
					<label for="inputName">Enter start price:</label>
					<input type="text" name="sprice" id="inputName" class="rounded-sm bg-gray-300/50">
				</div>
				<div class="block my-2">
					<label for="inputName">Enter end price:</label>
					<input type="text" name="eprice" id="inputName" class="rounded-sm bg-gray-300/50">
				</div>
				<div class="block my-2">
					<label for="inputName">Enter vendor_id:</label>
					<input type="text" name="vendor_id" id="inputName" class="rounded-sm bg-gray-300/50">
				</div>
				<div class="block my-2">
					<label for="inputName">Enter field:</label>
					<input type="text" name="field" id="inputName" class="rounded-sm bg-gray-300/50">
				</div>
				<div class="block my-2">
					<label for="inputName">Enter value:</label>
					<input type="text" name="field_value" id="inputName" class="rounded-sm bg-gray-300/50">
				</div>
				<button type="submit" name="submitData" class="w-full hover:shadow-form rounded-sm bg-[#6A64F1] py-3 px-8 text-base
	...
	<?php endif; ?>
	<form method="post">
		<button type="submit" name="appetizer_button" value="ResetView" onclick="window.location='http://google.com'" class="w-full hover:shadow-form rounded-sm bg-[#6A64F1] py-3 px-8 text-base
                font-semibold text-white outline-none">Reset View</button>
